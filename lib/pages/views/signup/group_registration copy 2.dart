...
class _GroupRegisterScreenState extends State<GroupRegisterScreen>
  ...
  String _localizedText(String en, String other) {
    return selectedLanguage == 'en' ? en : other;
  }
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: CustomSilverHeader().build(context, 0, false),
            ),
            expandedHeight: 250,
          ),
          SliverPersistentHeader(
            delegate: _TabBarSliverDelegate(
              TabBar(
                ...
                tabs: [
                  Tab(
                      text: _localizedText('Group Registration',
...
// Add this delegate for TabBar in SliverPersistentHeader
