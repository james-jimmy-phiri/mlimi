...
class _PotentialCustomersPageState extends State<PotentialCustomers> {
  ...
  Future<void> fetchCommodities() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('${apiurl}v1/profile/product-sale-offs'),
        headers: {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Bgreen,
        title: Text('Select the product you posted to see potential customers'),
      ),
      body: isLoading
          ? Center(
                                ...
                                Row(
                                  ...
                                  children: [
                                    TextButton(
                                      onPressed: () {},
                                      child: Text(
                                          'Potential Customers (${commodity['customers'].length})'),
                                    ),
                                    TextButton(
                                      onPressed: () {},
                                      child:
