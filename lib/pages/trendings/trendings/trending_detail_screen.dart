...
class _TrendingDetailScreenState extends State<TrendingDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Theme(
      data: ThemeData.dark().copyWith(scaffoldBackgroundColor: TrendingTheme.background),
      child: Scaffold(
                              ...
                              Positioned(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(_story!.title, style: TrendingTheme.displayLgMobile().copyWith(color: Colors.white)),
                                    const SizedBox(height: 12),
                                    GestureDetector(
