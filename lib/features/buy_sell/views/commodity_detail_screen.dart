...
class _CommodityDetailScreenState extends State<CommodityDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_details == null) {
      return Scaffold(
        ...
        body: const Center(child: Text('Commodity details unavailable')),
      );
    }
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (c.isAggregation) _buildAggregationSummary(c),
                  if (!c.isAggregation) _buildOwnerCard(c),
                  const SizedBox(height: 16),
                  _buildMetricsGrid(c),
                  const SizedBox(height: 16),
                  _buildPotentialInterestCard(c),
                  const SizedBox(height: 16),
  ...
  Widget _buildSliverAppBar(Commodity c) {
    return SliverAppBar(
      expandedHeight: 300,
      pinned: true,
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text('${progress * 100}%', style: const TextStyle(fontWeight: FontWeight.bold)),
              ],
            ),
            const SizedBox(height: 8),
            ClipRRect(
